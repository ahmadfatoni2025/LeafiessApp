                    ...
                    <div className="relative w-full max-w-2xl mx-auto z-50">
                        ...
                        <div className="relative flex flex-col items-center gap-6 md:gap-8">
                            ...
                            <motion.button
                                ...
                                className="relative w-full px-auto py-4 md:py-6 bg-gradient-to-r from-emerald-500 via-emerald-600 to-emerald-500 text-white font-black text-base md:text-lg uppercase tracking-wider rounded-2xl flex items-center justify-center gap-4 group overflow-hidden z-50"
                            >
